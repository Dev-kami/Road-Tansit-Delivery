  ...
  return (
    <section className="h-full w-full bg-home-image bg-cover bg-center text-white">
      ...
      <div className="lg:px-36 px-10 pt-32 h-[calc(100vh-3.5rem)]">
        <h1 className="font-lobster lg:text-6xl text-4xl pl-4 relative before:h-[calc(100%-1.5rem)] before:w-1 before:bg-gradient-to-b from-primary to-white before:absolute before:left-1">
